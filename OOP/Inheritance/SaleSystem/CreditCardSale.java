...
public class CreditCardSale extends Sale {
    ...
    public boolean equals(Object otherObject) {
        ...
        CreditCardSale creditCardSale = (CreditCardSale) otherObject;
        return (nameOnCard.equalsIgnoreCase(creditCardSale.nameOnCard)
                && creditCardNumber.equalsIgnoreCase(creditCardSale.creditCardNumber)
                && expiredDate.equals(creditCardSale.expiredDate));
    }
